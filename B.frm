   ...
   Begin VB.Menu report 
      ...
      Begin VB.Menu mnusetrpt 
         ...
         Begin VB.Menu mnubrshare 
            Caption         =   "Branchwise Shareing Report"
         End
...
Public Sub CONTRACTENTRY_Click()
    ...
    If GCtrType = "1" Then
        GETCont.Show
    ElseIf GCtrType = "3" Then
        SINGLECONTRACT.Show
    ElseIf GCtrType = "4" Then
        FRM_NEW_SINGLE_ENTRY.Show
    ElseIf GCtrType = "5" Then
        GET_CONTBS.Show
    ElseIf GCtrType = "6" Then
        Call Get_Selection(12)
        Frm_GetContSauda.Show
    ElseIf GCtrType = "7" Then
        Call Get_Selection(12)
        frmcont4.Show
    'ElseIf GCtrType = "8" Then
    '    Call Get_Selection(12)
    '    FrmCont5.Show
    ElseIf GCtrType = "2" Then
        CTRBUYSELL.Show
    End If
End Sub
...
Public Sub mnubrshare_Click()
    ...
    MFormat = "Branch Wise Shareing Report"
    Dim newfrm As New NRPTCONA
    newfrm.Show
End Sub
